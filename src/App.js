...
const SEED_ROWS = [
  { id: uid(), date: '2026-06-11', description: 'Opening Stock', type: 'in',  customer: '', qty: { '211G': 2, 'Bwm 303': 0, 'Bwm 777': 0 }, status: '' },
  { id: uid(), date: '2026-06-11', description: 'Received from Somicon', type: 'in',  customer: '', qty: { '211G': 31, 'Bwm 303': 24, 'Bwm 777': 5 }, status: '' },
  { id: uid(), date: '2026-06-11', description: 'Sale', type: 'out', customer: 'Matar Al Kutbi', qty: { '211G': 0, 'Bwm 303': 4, 'Bwm 777': 0 }, status: 'Delivered' },
  { id: uid(), date: '2026-06-12', description: 'Sale', type: 'out', customer: 'Omar Al Rahba', qty: { '211G': 10, 'Bwm 303': 0, 'Bwm 777': 0 }, status: 'Pending' },
  { id: uid(), date: '2026-06-12', description: 'Sale', type: 'out', customer: 'Sultan Al Habtoor', qty: { '211G': 5, 'Bwm 303': 0, 'Bwm 777': 0 }, status: 'Pending' },
  { id: uid(), date: '2026-06-12', description: 'Sale', type: 'out', customer: 'Omar Al Khazna', qty: { '211G': 0, 'Bwm 303': 3, 'Bwm 777': 0 }, status: 'Pending' },
  { id: uid(), date: '2026-06-12', description: 'Sale', type: 'out', customer: 'Al Hadeel', qty: { '211G': 0, 'Bwm 303': 6, 'Bwm 777': 0 }, status: 'Pending' },
  { id: uid(), date: '2026-06-12', description: 'Sale', type: 'out', customer: 'Adill', qty: { '211G': 0, 'Bwm 303': 0, 'Bwm 777': 20 }, status: 'Pending' },
];
...
export default function App() {
  ...
  function buildEmptyForm(prods) {
    ...
    return { date: today(), description: 'Sale', type: 'out', customer: '', qty, status: 'Pending' };
  }
    ...
    <div className="app">
      ...
      <header className="app-header">
        ...
        <div className="header-actions">
          ...
          <button className="btn btn-accent" onClick={() => { setForm(buildEmptyForm(products)); setShowAddRow(true); }}>
      ...
      <div className="table-wrap">
        <table className="stock-table">
          ...
          <tbody>
            {visible.length === 0 && (
              <tr><td colSpan={products.length + 5} className="empty-state">No records match your filters.</td></tr>
            )}
            {visible.map(row => {
      ...
      {showAddRow && (
        <Modal title="Add Transaction" onClose={() => setShowAddRow(false)}>
          ...
          <div className="modal-footer">
            ...
            <button className="btn btn-accent" onClick={submitRow}><Plus size={14} /> Add</button>
          </div>
        </Modal>
      )}
